...
<header>
   <?php
        $formulario = 'tipospoda';
          include_once("menu.php");
         
        ?>
        </header>
          <div class="container-fluid">
        <h1>Formulario TiposPoda </h1>
        <table class="table table-striped table-responsive">
            <tbody>
                <tr>
                    
                    <th scope="col">DescripcionTipoPoda</th>
                </tr>
   <?php
       ...
       $conexion = $objetoConexion->conectar();
        ...
        while($unRegistro = mysqli_fetch_array($listaTiposPoda)){
            
                echo '<tr><form id="fModificarTiposPoda"'.$unRegistro["IdTiposPoda"].' action="../controlador/controladorTiposPoda.php"method="post">';
                echo '<td><input    type="hidden"  name="fIdTiposPoda"                    value="'.$unRegistro['IdTiposPoda'].'">';
                echo '<input        type="text"  class="form-control"   name="fDescripcionTipoPoda"           value="'.$unRegistro['DescripcionTipoPoda'].'"></td>';
            ...
            <tr><form id="fIngresarTiposPoda" action="../controlador/controladorTiposPoda.php" method="post">
                <td><input  type="hidden" class="form-control" name="fIdTiposPoda" value="0">
                    <input  type="text"   class="form-control" name="fDescripcionTipoPoda"></td>
...
<?php
$cantPaginas=$objetoTiposPoda->cantidadPaginas();
if ($cantPaginas>1){
...
echo '<li><a heref="formulariotipospoda.php?pag=' .$i. '</a></li>';
     }
}
